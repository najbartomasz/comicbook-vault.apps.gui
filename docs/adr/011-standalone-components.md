...
- [ADR-013: Angular Material](./013-angular-material-for-ui-components.md) - Material modules work seamlessly with standalone
- [ADR-012: Signals for State Management](./012-signals-for-state-management.md) - Modern Angular patterns with standalone
